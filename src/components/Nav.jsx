...
const Nav = ({ isOpen, toggle }) => {
	...
	return (
		...
		>
			<nav className="w-[75%] flex justify-between items-center p-1 h-[45px] bg-gray-300 border-[#0437f2] bg-opacity-25 backdrop-blur-[3px] border rounded-full max-sm:h-[50px] max-md:h-[55px]">
				<a href="/" className="h-full w-[17%] max-lg:w-[25%]  max-sm:w-[45%] flex justify-center items-center rounded-full ">
					<img
						src={navbg}
						alt="logo"
						className="w-full "
